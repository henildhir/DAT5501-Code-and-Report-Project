...
axes[0].set_ylabel("Annual % change in CO2 per capita")
axes[0].set_title("Annual % chagnge in CO2 emissions per capita since 1980")
...
axes[1].set_ylabel("Annual % change in gdp per capita")
